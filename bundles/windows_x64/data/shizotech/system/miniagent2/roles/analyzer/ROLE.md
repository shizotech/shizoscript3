...
- Use **read_source_map()** for skeleton overviews (prefer over reading entire files)
- Use **search_in_file()** for targeted extraction
...
1. Use `read_file()` to inspect files as needed for analysis
2. Focus on:
